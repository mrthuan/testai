...
public final class c {
    ...
    public static final ThreadLocal<Matrix> f30995a = new ThreadLocal<>();

    /* renamed from: b  reason: collision with root package name */
    public static final ThreadLocal<RectF> f30996b = new ThreadLocal<>();
    ...
    public static void c(ViewGroup viewGroup, View view, Rect rect) {
        ThreadLocal<Matrix> threadLocal = f30995a;
        ...
        ThreadLocal<RectF> threadLocal2 = f30996b;
