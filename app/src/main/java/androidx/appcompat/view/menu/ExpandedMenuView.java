...
public final class ExpandedMenuView extends ListView implements h.b, o, AdapterView.OnItemClickListener {
    ...
    public static final int[] f1968b = {16842964, 16843049};
    ...
    public final boolean a(j jVar) {
        return this.f1969a.q(jVar, null, 0);
    }
    ...
    public ExpandedMenuView(Context context, AttributeSet attributeSet, int i10) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, f1968b, i10, 0);
        if (obtainStyledAttributes.hasValue(0)) {
            if (obtainStyledAttributes.hasValue(0) && (resourceId2 = obtainStyledAttributes.getResourceId(0, 0)) != 0) {
                drawable2 = m.a.a(context, resourceId2);
            } else {
