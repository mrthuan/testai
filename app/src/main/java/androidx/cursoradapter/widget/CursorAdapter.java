...
public abstract class CursorAdapter extends BaseAdapter implements Filterable, a.InterfaceC0015a {
    @Deprecated
    ...
    protected androidx.cursoradapter.widget.a mCursorFilter;
    ...
    @Override // androidx.cursoradapter.widget.a.InterfaceC0015a
    ...
    public View getView(int i10, View view, ViewGroup viewGroup) {
        if (this.mDataValid) {
            ...
            throw new IllegalStateException(b.a.c("couldn't move cursor to position ", i10));
        }
