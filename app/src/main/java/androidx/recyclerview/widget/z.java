...
public final class z extends a0 {
    ...
    public final int b(View view) {
        ...
        return RecyclerView.m.G(view) + view.getBottom() + ((ViewGroup.MarginLayoutParams) ((RecyclerView.n) view.getLayoutParams())).bottomMargin;
    }
    ...
    public final int e(View view) {
        this.f4390a.getClass();
        return (view.getTop() - RecyclerView.m.T(view)) - ((ViewGroup.MarginLayoutParams) ((RecyclerView.n) view.getLayoutParams())).topMargin;
    }

    @Override // androidx.recyclerview.widget.a0
    public final int f() {
        return this.f4390a.f4298o;
    }
    ...
    @Override // androidx.recyclerview.widget.a0
    public final int h() {
        return this.f4390a.getPaddingBottom();
    }
    ...
    @Override // androidx.recyclerview.widget.a0
    public final int k() {
        return this.f4390a.getPaddingTop();
    }

    @Override // androidx.recyclerview.widget.a0
    public final int l() {
        RecyclerView.m mVar = this.f4390a;
        return (mVar.f4298o - mVar.getPaddingTop()) - mVar.getPaddingBottom();
    }
