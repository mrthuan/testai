...
@wf.c(c = "pdf.pdfreader.viewer.editor.free.billing.BillingRepository$fetchSubscribeInfoSafely$2", f = "BillingRepository.kt", l = {97}, m = "invokeSuspend")
/* loaded from: classes3.dex */
public final class BillingRepository$fetchSubscribeInfoSafely$2 extends SuspendLambda implements p<w, kotlin.coroutines.c<? super Result<? extends tf.d>>, Object> {
    private /* synthetic */ Object L$0;
    int label;

    public BillingRepository$fetchSubscribeInfoSafely$2(kotlin.coroutines.c<? super BillingRepository$fetchSubscribeInfoSafely$2> cVar) {
        super(2, cVar);
    }

    @Override // kotlin.coroutines.jvm.internal.BaseContinuationImpl
    public final kotlin.coroutines.c<tf.d> create(Object obj, kotlin.coroutines.c<?> cVar) {
        BillingRepository$fetchSubscribeInfoSafely$2 billingRepository$fetchSubscribeInfoSafely$2 = new BillingRepository$fetchSubscribeInfoSafely$2(cVar);
        billingRepository$fetchSubscribeInfoSafely$2.L$0 = obj;
        return billingRepository$fetchSubscribeInfoSafely$2;
    }
    ...
    public final Object invoke2(w wVar, kotlin.coroutines.c<? super Result<tf.d>> cVar) {
        return ((BillingRepository$fetchSubscribeInfoSafely$2) create(wVar, cVar)).invokeSuspend(tf.d.f30009a);
    }
}
