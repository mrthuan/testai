...
public class c {
    ...
    private static WindowManager f13889a;

    /* renamed from: b  reason: collision with root package name */
    private static String[] f13890b = {"x", OperatorName.CURVE_TO_REPLICATE_FINAL_POINT, InMobiNetworkValues.WIDTH, InMobiNetworkValues.HEIGHT};
    ...
    public static void b(JSONObject jSONObject) {
        b a10 = a(jSONObject);
        try {
            jSONObject.put(InMobiNetworkValues.WIDTH, a10.f13892a);
            jSONObject.put(InMobiNetworkValues.HEIGHT, a10.f13893b);
    ...
    private static b a(JSONObject jSONObject) {
        ...
        if (f13889a != null) {
            ...
            f13889a.getDefaultDisplay().getRealSize(point);
            f10 = a(point.x);
            f11 = a(point.y);
        } else {
            f10 = 0.0f;
    ...
    public static void a(Context context) {
        if (context != null) {
            ...
            f13889a = (WindowManager) context.getSystemService("window");
        }
    }
    ...
    public static void a(JSONObject jSONObject, a.C0181a c0181a) {
        com.iab.omid.library.bytedance2.internal.e a10 = c0181a.a();
        JSONArray jSONArray = new JSONArray();
        for (String str : c0181a.b()) {
            jSONArray.put(str);
        }
        try {
    ...
    private static boolean a(OutputDeviceStatus outputDeviceStatus) {
        return a.f13891a[outputDeviceStatus.ordinal()] == 1;
    }
