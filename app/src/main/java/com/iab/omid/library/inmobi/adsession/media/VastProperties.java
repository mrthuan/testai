...
public final class VastProperties {
    ...
    private final Position f13943d;

    private VastProperties(boolean z10, Float f10, boolean z11, Position position) {
        this.f13941a = z10;
        this.f13942b = f10;
        this.c = z11;
        this.f13943d = position;
    }
    ...
    public JSONObject a() {
        ...
        try {
            jSONObject.put("skippable", this.f13941a);
            if (this.f13941a) {
                jSONObject.put("skipOffset", this.f13942b);
            }
            jSONObject.put("autoPlay", this.c);
            jSONObject.put("position", this.f13943d);
