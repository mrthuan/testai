    ...
    public final zzmt zza(Class cls) {
        ...
        if (zzb.zzb()) {
            if (zzlb.class.isAssignableFrom(cls)) {
                return zzmm.zzc(zzmv.zzA(), zzkq.zzb(), zzb.zza());
            }
            return zzmm.zzc(zzmv.zzy(), zzkq.zza(), zzb.zza());
        } else if (zzlb.class.isAssignableFrom(cls)) {
            if (zzb(zzb)) {
                return zzml.zzl(cls, zzb, zzmo.zzb(), zzlw.zzd(), zzmv.zzA(), zzkq.zzb(), zzme.zzb());
            }
            return zzml.zzl(cls, zzb, zzmo.zzb(), zzlw.zzd(), zzmv.zzA(), null, zzme.zzb());
        } else if (zzb(zzb)) {
            return zzml.zzl(cls, zzb, zzmo.zza(), zzlw.zzc(), zzmv.zzy(), zzkq.zza(), zzme.zza());
        } else {
            return zzml.zzl(cls, zzb, zzmo.zza(), zzlw.zzc(), zzmv.zzz(), null, zzme.zza());
        }
    }
}
