...
public final class zzbto implements Thread.UncaughtExceptionHandler {
    final /* synthetic */ Thread.UncaughtExceptionHandler zza;
    final /* synthetic */ zzbtq zzb;

    public zzbto(zzbtq zzbtqVar, Thread.UncaughtExceptionHandler uncaughtExceptionHandler) {
