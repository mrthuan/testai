...
public final class zzol implements zzok {
    ...
    static {
        ...
        zzg = zza2.zze("measurement.config.url_scheme", Constants.SCHEME);
        ...
        zzt = zza2.zzd("measurement.service_client.idle_disconnect_millis", TelemetryConfig.DEFAULT_LOG_RETRY_INTERVAL);
