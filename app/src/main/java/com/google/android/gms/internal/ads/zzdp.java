...
public final class zzdp implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public final void zzb(int i10) {
        ...
        int[] iArr3 = new int[2];
        zzdr.zza(EGL14.eglInitialize(eglGetDisplay, iArr3, 0, iArr3, 1), "eglInitialize failed");
        ...
        zzdr.zza(z11, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr4[0]), eGLConfigArr[0]));
        ...
        zzdr.zza(EGL14.eglMakeCurrent(eGLDisplay2, eglCreatePbufferSurface, eglCreatePbufferSurface, eglCreateContext), "eglMakeCurrent failed");
