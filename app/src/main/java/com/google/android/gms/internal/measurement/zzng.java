...
public class zzng extends AbstractMap {
    ...
    private final int zzk(Comparable comparable) {
        ...
        while (i10 <= size) {
            int i11 = (i10 + size) / 2;
            int compareTo2 = comparable.compareTo(((zzna) this.zzb.get(i11)).zza());
            if (compareTo2 < 0) {
                size = i11 - 1;
    ...
    public final Object zzl(int i10) {
        zzn();
        Object value = ((zzna) this.zzb.remove(i10)).getValue();
        if (!this.zzc.isEmpty()) {
    ...
    public final boolean equals(Object obj) {
        ...
        if (zzb == zzngVar.zzb()) {
            for (int i10 = 0; i10 < zzb; i10++) {
                if (!zzg(i10).equals(zzngVar.zzg(i10))) {
                    return false;
                }
            }
            if (zzb == size) {
    ...
    public final int hashCode() {
        ...
        for (int i11 = 0; i11 < zzb; i11++) {
            i10 += ((zzna) this.zzb.get(i11)).hashCode();
        }
        if (this.zzc.size() > 0) {
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        int i11 = this.zza;
        if (size == i11) {
            zzna zznaVar = (zzna) this.zzb.remove(i11 - 1);
            zzm().put(zznaVar.zza(), zznaVar.getValue());
        }
        this.zzb.add(i10, new zzna(this, comparable, obj));
        return null;
    }
