...
public final class zzgd extends zzlb implements zzmj {
    ...
    public static /* synthetic */ void zzaE(zzgd zzgdVar, long j10) {
        zzgdVar.zze |= Variant.VT_RESERVED;
        zzgdVar.zzx = 77000L;
    }
    ...
    public static /* synthetic */ void zzag(zzgd zzgdVar, long j10) {
        zzgdVar.zzf |= Variant.VT_RESERVED;
        zzgdVar.zzag = j10;
    }
    ...
    public final boolean zzbq() {
        if ((this.zzf & Variant.VT_RESERVED) != 0) {
            return true;
        }
        return false;
    }
    ...
    public final boolean zzbt() {
        if ((this.zze & Variant.VT_RESERVED) != 0) {
            return true;
        }
        return false;
    }
