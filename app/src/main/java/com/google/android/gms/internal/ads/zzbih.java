...
final class zzbih implements zzbix {
    ...
    public final void zza(Object obj, Map map) {
        ...
        if (zzxVar.f10339e && (zzftaVar = zzxVar.f10338d) != null) {
            zzftaVar.zza(zzxVar.d(), zzxVar.f10340f);
            zzbzo.zze.execute(new com.google.android.gms.ads.internal.overlay.zzv(zzxVar, "onLMDOverlayCollapse", new HashMap()));
            return;
        }
