...
public class InMobiWaterfallInterstitialAd extends InMobiInterstitialAd {
    ...
    public void internalLoadAd(InMobiInterstitialWrapper inMobiInterstitialWrapper) {
        ...
        InMobiExtras build = InMobiExtrasBuilder.build(mediationInterstitialAdConfiguration.f10582d, mediationInterstitialAdConfiguration.c, InMobiAdapterUtils.PROTOCOL_WATERFALL);
