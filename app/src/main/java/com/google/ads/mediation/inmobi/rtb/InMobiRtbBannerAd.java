...
public class InMobiRtbBannerAd extends InMobiBannerAd {
    ...
    public void internalLoadAd(InMobiBannerWrapper inMobiBannerWrapper) {
        ...
        InMobiExtras build = InMobiExtrasBuilder.build(mediationBannerAdConfiguration.f10582d, mediationBannerAdConfiguration.c, InMobiAdapterUtils.PROTOCOL_RTB);
        inMobiBannerWrapper.setExtras(build.getParameterMap());
        inMobiBannerWrapper.setKeywords(build.getKeywords());
        inMobiBannerWrapper.load(this.mediationBannerAdConfiguration.f10580a.getBytes());
    }
}
