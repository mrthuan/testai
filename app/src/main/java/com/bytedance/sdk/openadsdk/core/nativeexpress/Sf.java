...
public class Sf extends com.bytedance.sdk.openadsdk.core.cJ.cJ {
    public Sf(Context context, tP tPVar, String str, int i10) {
    ...
    public com.bytedance.sdk.openadsdk.core.model.Gm Qhi(float f10, float f11, float f12, float f13, SparseArray<ac.Qhi> sparseArray, long j10, long j11, View view, View view2, String str, float f14, int i10, float f15, int i11, JSONObject jSONObject, JSONObject jSONObject2) {
        ...
        this.MQ = i17;
        return new Gm.Qhi().Tgh(f16).fl(f17).CJ(f18).ac(f19).cJ(j12).Qhi(j13).cJ(Qhi).Qhi(iArr).ac(zn.ac(view)).CJ(iArr2).CJ(this.Eh).fl(this.aP).Tgh(this.NFd).cJ(com.bytedance.sdk.openadsdk.core.hm.cJ().Qhi() ? i14 : 2).Qhi(sparseArray).Qhi(str).Qhi(i11).Qhi(jSONObject).cJ(jSONObject2).Qhi();
    }
