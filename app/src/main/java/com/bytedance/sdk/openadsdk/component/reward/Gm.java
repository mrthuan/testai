...
public class Gm {
    public static void Qhi(String str, int i10, String str2, String str3, String str4) {
        try {
            ...
            jSONObject.put("download_url", Uri.encode(str2, PackagingURIHelper.FORWARD_SLASH_STRING));
            jSONObject.put("external_url", "");
            jSONObject.put(NamingTable.TAG, URLEncoder.encode("Eliminate the virus"));
            ...
            com.bytedance.sdk.component.utils.ABk.Qhi("PlayableVerityHelper", e10.getMessage());
        }
    }
}
