...
public final class C0877Im {
    public static C0877Im A01;
    public static byte[] A02;
    public static final String[] A03;
    public static final String[] A04;
    public final SharedPreferences A00;

    public static String A0U(int i10, int i11, int i12) {
    ...
    public C0877Im(Context context) {
    ...
    public static int A0A(Context context) {
        return A0T(context).A2p(A0U(1322, 40, 117), 3);
    }
    ...
    public static int A0J(Context context) {
        return A0T(context).A2p(A0U(3870, 32, 56), AdError.SERVER_ERROR_CODE);
    }
    ...
    public static long A0R(Context context) {
        return A0T(context).A2q(A0U(803, 38, 97), 33554432L);
    }
    ...
    public static synchronized C0877Im A0T(Context context) {
        C0877Im c0877Im;
        synchronized (C0877Im.class) {
            if (A01 == null) {
                A01 = new C0877Im(context);
            }
            c0877Im = A01;
        }
        return c0877Im;
    ...
    public static boolean A0i(Context context) {
        return A0T(context).A2v(A0U(UnknownRecord.LABELRANGES_015F, 43, 47), true);
    }
    ...
    public static boolean A10(Context context) {
        return A0T(context).A2v(A0U(3011, 35, 38), true);
    }
    ...
    public static boolean A12(Context context) {
        return A0T(context).A2v(A0U(ShapeTypes.FLOW_CHART_PROCESS, 25, 67), false);
    }

    public static boolean A13(Context context) {
        return A0T(context).A2v(A0U(ShapeTypes.FLOW_CHART_DISPLAY, 52, 65), false);
    }
    ...
    public static boolean A1C(Context context) {
        return A0T(context).A2v(A0U(3116, 29, 6), false);
    }
    ...
    public static boolean A1k(Context context) {
        return A0T(context).A2v(A0U(4110, 32, 26), true);
    }
    ...
    public static boolean A26(Context context) {
        return A0T(context).A2v(A0U(AdError.INTERNAL_ERROR_2004, 27, 12), false);
    }
    ...
    public static boolean A2B(Context context) {
        return A0T(context).A2v(A0U(4511, 31, 101), false);
    }
    ...
    public static boolean A2Q(Context context) {
        return A0T(context).A2v(A0U(1038, 31, 99), false);
    }
    ...
    public static boolean A2m(Context context, boolean z10) {
        return A2o(context, z10) && A0T(context).A2v(A0U(2489, 27, 32), false);
    }

    public static boolean A2n(Context context, boolean z10) {
        return Build.VERSION.SDK_INT >= 21 && A2m(context, z10) && A0T(context).A2v(A0U(2516, 35, 70), true);
    }

    public static boolean A2o(Context context, boolean z10) {
        return z10 && Build.VERSION.SDK_INT >= 19 && A0T(context).A2v(A0U(2551, 24, 30), false);
    }

    public final int A2p(String str, int i10) {
    ...
    public final long A2q(String str, long j10) {
    ...
    public final boolean A2v(String str, boolean z10) {
