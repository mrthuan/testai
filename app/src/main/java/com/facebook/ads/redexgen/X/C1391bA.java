...
public final class C1391bA<K, V> extends AnonymousClass31<K, V> implements Map<K, V> {
    public AbstractC05072y<K, V> A00;
    ...
    private AbstractC05072y<K, V> A00() {
        if (this.A00 == null) {
            this.A00 = new C1392bB(this);
        }
        return this.A00;
    }
