...
public class View$OnClickListenerC1030Oq implements View.OnClickListener {
    ...
    public static void A01() {
        A01 = new byte[]{Field.SHAPE, 64, 77, 76, Field.FORMTEXT};
    }

    public View$OnClickListenerC1030Oq(BX bx) {
        this.A00 = bx;
    }
