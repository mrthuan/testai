...
public final class C04902h extends Drawable {
    ...
    public C04902h(ColorStateList colorStateList, float f10) {
        this.A01 = f10;
        A01(colorStateList);
        this.A0A = new RectF();
        this.A09 = new Rect();
    ...
    private void A02(Rect rect) {
        ...
        this.A09.set(rect);
        if (this.A06) {
            float A01 = C04922j.A01(this.A00, this.A01, this.A07);
            float vInset = C04922j.A00(this.A00, this.A01, this.A07);
