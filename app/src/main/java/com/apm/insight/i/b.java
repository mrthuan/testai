...
public class b implements c {
    ...
    private synchronized void b(final long j10, final Thread thread, final Throwable th2, final String str, File file, final String str2, final boolean z10) {
        final File file2 = new File(n.a(this.f6545a), str);
        ...
        com.apm.insight.entity.a a10 = f.a().a(CrashType.LAUNCH, null, new c.a() { // from class: com.apm.insight.i.b.1
            ...
            public com.apm.insight.entity.a a(int i10, com.apm.insight.entity.a aVar) {
                String str3;
                String valueOf;
                this.f6546a = SystemClock.uptimeMillis();
                if (i10 == 0) {
                    ...
                    aVar.a("main_process", Boolean.valueOf(com.apm.insight.l.a.b(b.this.f6545a)));
                    ...
                    if (c) {
                        com.apm.insight.l.a.a(b.this.f6545a, aVar.h());
                    }
                    aVar.a("launch_did", (Object) a.a(b.this.f6545a));
                    JSONArray c10 = g.b().c();
    ...
    public void a(long j10, Thread thread, Throwable th2, String str, File file, String str2, boolean z10) {
        b(j10, thread, th2, str, file, str2, z10);
    }
