...
public final class Q1 implements V1 {
    ...
    public final /* synthetic */ R1 f14584a;
    ...
    public final void a(N1 click, EnumC1849w3 errorCode) {
        ...
        A4 a42 = this.f14584a.f14603a;
        if (a42 != null) {
            String f10 = Y1.f();
            ((B4) a42).b(f10, androidx.activity.r.g(A5.a(f10, "access$getTAG$p(...)", "Pinging click ("), click.f14507b, ") via WebView failed ..."));
        }
        Y1.c(Y1.f14860a, click);
        this.f14584a.b(click);
    }
}
