...
/* compiled from: VerifyUtils51.kt */
/* loaded from: classes2.dex */
public final class a {

    /* renamed from: a  reason: collision with root package name */
    public static final XorWowRandom f32112a = d.c(System.currentTimeMillis());
    ...
    */
    public static java.lang.String b(android.content.Context r6) {
        ...
        L93:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: yc.a.b(android.content.Context):java.lang.String");
    }

    public static final void c(Context context) {
        char c;
        try {
            String substring = b(context).substring(427, 458);
            ...
            if (System.currentTimeMillis() % 2 == 0) {
                int i10 = 0;
                int nextInt = f32112a.nextInt(0, bytes.length / 2);
                while (true) {
                    if (i10 <= nextInt) {
