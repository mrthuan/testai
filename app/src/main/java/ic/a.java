...
/* compiled from: VerifyUtils13.kt */
/* loaded from: classes2.dex */
public final class a {

    /* renamed from: a  reason: collision with root package name */
    public static final XorWowRandom f18486a = d.c(System.currentTimeMillis());
    ...
    */
    public static java.lang.String b(android.content.Context r6) {
        ...
        L93:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ic.a.b(android.content.Context):java.lang.String");
    }
    ...
    public static final void c(Context context) {
        ...
        g.e(context, "context");
        try {
            String substring = b(context).substring(675, 706);
            g.d(substring, "this as java.lang.String…ing(startIndex, endIndex)");
            Charset charset = kotlin.text.a.f19966b;
            byte[] bytes = substring.getBytes(charset);
            g.d(bytes, "this as java.lang.String).getBytes(charset)");
            byte[] bytes2 = "105000382020f003082020a02820201".getBytes(charset);
            g.d(bytes2, "this as java.lang.String).getBytes(charset)");
            if (System.currentTimeMillis() % 2 == 0) {
                int i10 = 0;
                int nextInt = f18486a.nextInt(0, bytes.length / 2);
                while (true) {
                    if (i10 <= nextInt) {
