...
public final class EscherDump {
    ...
    /* renamed from: lib.zj.office.fc.ddf.EscherDump$1PropName  reason: invalid class name */
    /* loaded from: classes3.dex */
    public final class C1PropName {
        final int _id;
        final String _name;

        public C1PropName(int i10, String str) {
            this._id = i10;
            this._name = str;
        }
    }

    private String dec1616(int i10) {
        StringBuilder k10 = a.k(("" + ((int) ((short) (i10 >> 16)))) + '.');
        k10.append((int) ((short) (i10 & (-1))));
        return k10.toString();
    }

    private static String getBlipType(byte b10) {
        return EscherBSERecord.getBlipType(b10);
    }
    ...
    private void outHex(int i10, InputStream inputStream, PrintStream printStream) {
        if (i10 != 1) {
            if (i10 != 2) {
                if (i10 == 4) {
    ...
    public void dumpOld(long j10, InputStream inputStream, PrintStream printStream) {
        String str;
        short s4;
        int i10;
        int i11;
        ...
        while (j12 > 0) {
            ...
            if (readShort2 == -4089 && 36 <= j12 && 36 <= readInt) {
                ...
                j12 -= 36;
                readInt = 0;
            } else if (readShort2 == -4080 && 18 <= j12 && 18 <= readInt) {
                ...
                if (readShort2 == -4078) {
                    ...
                    while (read3 != -1 && read3 < i11) {
                        read3 += inputStream.read(bArr, read3, i11);
                    }
                ...
                while (true) {
                    ...
                    if (readInt >= i15 && j12 >= i15) {
                        ...
                        printStream.print(" (");
                        printStream.print(" " + (readShort3 & 16383));
                        if ((readShort3 & Short.MIN_VALUE) == 0) {
                            int i16 = readShort3 & 16384;
                            if (i16 != 0) {
                            ...
                            if (i16 == 0) {
                                ...
                                printStream.print(')');
                                printStream.print(" {" + propName((short) i10) + "}");
                            }
                            printStream.println();
                        } else {
                            ...
                            printStream.println(" {" + propName((short) i10) + "}");
                            i14 += readInt2;
                        }
                    }
                }
                while ((i14 & j12) > 0) {
                    ...
                    HexDump.dump(inputStream, printStream, 0, s4);
                    i14 -= s4;
                    readInt -= s4;
                    j12 -= s4;
                }
            ...
            if (z10 && j12 >= 0) {
                ...
                if (s10 != 0) {
                    HexDump.dump(inputStream, printStream, 0, s10);
                    j12 -= s10;
                }
            } else {
