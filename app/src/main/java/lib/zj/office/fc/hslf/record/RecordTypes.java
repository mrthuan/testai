...
public final class RecordTypes {
    ...
    public static final Type Slide = new Type(ErrorCodes.SSL_HANDSHAKE_EXCEPTION, Slide.class);
    public static final Type SlideAtom = new Type(ErrorCodes.IO_EXCEPTION, SlideAtom.class);
    ...
    public static final Type VBAInfo = new Type(IEEEDouble.EXPONENT_BIAS, null);
    ...
    public static final Type List = new Type(AdError.SERVER_ERROR_CODE, List.class);
    ...
    public static final Type PersistPtrFullBlock = new Type(AdError.MEDIAVIEW_MISSING_ERROR_CODE, PersistPtrHolder.class);
    public static final Type PersistPtrIncrementalBlock = new Type(AdError.ICONVIEW_MISSING_ERROR_CODE, PersistPtrHolder.class);
    public static final Type GScalingAtom = new Type(Constants.CP_MAC_JAPAN, null);
    public static final Type GRColorAtom = new Type(Constants.CP_MAC_CHINESE_TRADITIONAL, null);
    ...
    public static final Type SlideShowSlideInfoAtom = new Type(1017, SlideShowSlideInfoAtom.class);
        ...
        try {
            ...
            for (int i10 = 0; i10 < fields.length; i10++) {
                ...
                if (obj instanceof Integer) {
                    typeToName.put((Integer) obj, fields[i10].getName());
                }
                if (obj instanceof Type) {
                    Type type = (Type) obj;
                    Class<? extends Record> cls = type.handlingClass;
                    Integer valueOf = Integer.valueOf(type.typeID);
                    if (cls == null) {
                        cls = UnknownRecordPlaceholder.class;
                    }
                    typeToName.put(valueOf, fields[i10].getName());
                    typeToClass.put(valueOf, cls);
                }
            }
    ...
    public static Class<? extends Record> recordHandlingClass(int i10) {
        return typeToClass.get(Integer.valueOf(i10));
    }

    public static String recordName(int i10) {
        String str = typeToName.get(Integer.valueOf(i10));
        if (str == null) {
            return a.c(OpenTypeScript.UNKNOWN, i10);
        }
        return str;
    }
}
