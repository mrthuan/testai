...
public final class Vlookup extends Var3or4ArgFunction {
    ...
    private LookupUtils.ValueVector createResultColumnVector(TwoDEval twoDEval, int i10) {
        if (i10 < twoDEval.getWidth()) {
            return LookupUtils.createColumnVector(twoDEval, i10);
        }
    ...
    public ValueEval evaluate(int i10, int i11, ValueEval valueEval, ValueEval valueEval2, ValueEval valueEval3, ValueEval valueEval4) {
        try {
            ...
            return createResultColumnVector(resolveTableArrayArg, LookupUtils.resolveRowOrColIndexArg(valueEval3, i10, i11)).getItem(LookupUtils.lookupIndexOfValue(i10, i11, singleValue, LookupUtils.createColumnVector(resolveTableArrayArg, 0), LookupUtils.resolveRangeLookupArg(valueEval4, i10, i11)));
