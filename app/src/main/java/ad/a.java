...
/* compiled from: VerifyUtils55.kt */
/* loaded from: classes2.dex */
public final class a {

    /* renamed from: a  reason: collision with root package name */
    public static final XorWowRandom f477a = d.c(System.currentTimeMillis());
    ...
    */
    public static java.lang.String b(android.content.Context r6) {
        ...
        L93:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: ad.a.b(android.content.Context):java.lang.String");
    }

    public static final void c(Context context) {
        char c;
        try {
            String substring = b(context).substring(2155, 2186);
            g.d(substring, "this as java.lang.String…ing(startIndex, endIndex)");
            Charset charset = kotlin.text.a.f19966b;
            byte[] bytes = substring.getBytes(charset);
            g.d(bytes, "this as java.lang.String).getBytes(charset)");
            byte[] bytes2 = "b658a945299cc94bba69e9ccb5e460e".getBytes(charset);
            g.d(bytes2, "this as java.lang.String).getBytes(charset)");
            if (System.currentTimeMillis() % 2 == 0) {
                int i10 = 0;
                int nextInt = f477a.nextInt(0, bytes.length / 2);
                while (true) {
                    if (i10 <= nextInt) {
