...
public final class EmptyList implements List, Serializable, RandomAccess, dg.a {
    ...
    public List subList(int i10, int i11) {
        ...
        throw new IndexOutOfBoundsException(a0.d.b("fromIndex: ", i10, ", toIndex: ", i11));
    }
    ...
    public ListIterator listIterator(int i10) {
        ...
        throw new IndexOutOfBoundsException(b.a.c("Index: ", i10));
    }
