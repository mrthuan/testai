...
public final class g implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final /* synthetic */ AppCompatTextView f29635a;

    public g(AppCompatTextView appCompatTextView) {
        this.f29635a = appCompatTextView;
    }

    @Override // android.view.ViewTreeObserver.OnPreDrawListener
    public final boolean onPreDraw() {
        AppCompatTextView appCompatTextView = this.f29635a;
        Layout layout = appCompatTextView.getLayout();
        if (layout != null && layout.getLineCount() >= 3) {
            int dimensionPixelSize = appCompatTextView.getResources().getDimensionPixelSize(R.dimen.sp_18);
            int dimensionPixelSize2 = appCompatTextView.getResources().getDimensionPixelSize(R.dimen.sp_12);
            try {
