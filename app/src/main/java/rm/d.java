...
public final class d implements ViewTreeObserver.OnPreDrawListener {
    ...
    public final /* synthetic */ AppCompatTextView f29630a;

    public d(AppCompatTextView appCompatTextView) {
        this.f29630a = appCompatTextView;
    }

    @Override // android.view.ViewTreeObserver.OnPreDrawListener
    public final boolean onPreDraw() {
        AppCompatTextView appCompatTextView = this.f29630a;
        Layout layout = appCompatTextView.getLayout();
        if (layout != null && layout.getLineCount() >= 3) {
            int dimensionPixelSize = appCompatTextView.getResources().getDimensionPixelSize(R.dimen.sp_14);
            int dimensionPixelSize2 = appCompatTextView.getResources().getDimensionPixelSize(R.dimen.sp_11);
            try {
